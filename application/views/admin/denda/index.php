<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0"><i class="fa fa-money-bill text-success"></i> Data Denda</h4>
</div>
                ...
                <tbody>
                    ...
                    foreach ($denda as $d): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('admin/denda/detail/' . $d['id_denda']); ?>" class="btn btn-sm btn-secondary"><i class="fa fa-info-circle"></i> Detail</a>
                                <?php if (!isset($d['status']) || $d['status'] != 'lunas'): ?>
