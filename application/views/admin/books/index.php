<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0"><i class="fa fa-book text-success"></i> Data Buku</h4>
    <a href="<?php echo site_url('admin/books/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Buku</a>
</div>
                ...
                <tbody>
                    ...
                    foreach ($books as $b): ?>
                        <tr>
                            ...
                            <td>
                                <a href="#" class="btn btn-sm btn-secondary"><i class="fa fa-info-circle"></i> Detail</a>
