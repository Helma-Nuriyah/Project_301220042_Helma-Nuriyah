<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0"><i class="fa fa-exchange-alt text-success"></i> Transaksi Peminjaman</h4>
</div>
...
<div class="card">
    <div class="card-body">
        <a href="<?php echo site_url('admin/transaksi/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Transaksi</a>
                ...
                <tbody>
                    ...
                    foreach ($transaksi as $t): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('admin/transaksi/detail/' . $t['id_pinjam']); ?>" class="btn btn-sm btn-secondary"><i class="fa fa-info-circle"></i> Detail</a>
                                <?php if ($t['status'] == 'dipinjam'): ?>
        ...
        <nav>
            <ul class="pagination justify-content-end">
                ...
                if ($page > 1): ?>
                    <li class="page-item">
                        <a class="page-link text-success" href="?q=<?php echo urlencode($keyword); ?>&page=<?php echo $prev; ?>" aria-label="Previous">
                ...
                for ($i = 1; $i <= $total_pages; $i++): ?>
                    <li class="page-item <?php if ($i == $page) echo 'active'; ?>">
                        <a class="page-link text-success" href="?q=<?php echo urlencode($keyword); ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                    </li>
                <?php endfor;
                if ($page < $total_pages): ?>
                    <li class="page-item">
                        <a class="page-link text-success" href="?q=<?php echo urlencode($keyword); ?>&page=<?php echo $next; ?>" aria-label="Next">
