<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0"><i class="fa fa-user text-success"></i> Profil Saya</h4>
</div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-4 text-center mb-3">
                ...
                <?php else: ?>
                    <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($user['nama'] ?? $user['user']); ?>&background=43A047&color=fff" class="rounded-circle mb-2" style="width:120px;height:120px;object-fit:cover;">
                <?php endif; ?>
