    ...
    <div class="d-flex">
        ...
        <nav class="sidebar p-0">
            ...
            <div class="user-panel d-flex align-items-center mb-3">
                <div class="image">
                    <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($this->session->userdata('nama')); ?>&background=43A047&color=fff" class="img-circle" width="40" alt="User Image">
                </div>
                <div class="info ml-2">
